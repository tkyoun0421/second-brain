...
import {
  ...
  previewMemoryForget,
  supersedeMemory,
} from "#app/modules/memories/memories.service.js";
import {
  bodyOf,
  idempotencyKeyOf,
  numericPathId,
...
export const registerMemoriesWriteController = (app: FastifyInstance, { database, forgetPreviewSecret }: RouteDependencies) => {
