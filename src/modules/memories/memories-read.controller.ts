...
import { getMemoryDetail, listMemoryInbox, queryContext, searchMemories } from "#app/modules/memories/memories-query.service.js";
import { contextQuerySchema, memoryInboxQuerySchema, memorySearchSchema } from "#app/common/validation/schemas.js";
...
export const registerMemoriesReadController = (app: FastifyInstance, { database }: RouteDependencies) => {
